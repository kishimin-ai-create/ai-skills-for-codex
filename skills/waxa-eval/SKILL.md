...
When you see an unclear-point, ask: _what class of mistake produced this?_ Not "this exact thing went wrong" — _what shape of error would always produce this kind of failure?_ The class-level rule is what generalizes; the trace is just the example.
